...
ALTER TABLE `admins_roless` ADD `r_merchant` ENUM('y','n') NOT NULL DEFAULT 'n' AFTER `r_export_transaction`;
ALTER TABLE `tradein` ADD `merchant_id` INT(11) NULL DEFAULT NULL AFTER `user_id`;
