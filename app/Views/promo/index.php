          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="datatable1" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th rowspan="2" class="v-align-center">No</th>
                    <th colspan="2" class="text-center">Promo</th>
                    <th colspan="2" class="text-center">Date</th>
                    <th rowspan="2" class="v-align-center">Last Updated</th>
                    <th rowspan="2" class="v-align-center">Status / Action</th>
                  </tr>
                  <tr>
                    <th>ID</th>
                    <th>Name</th>
  ...
  $(document).ready(function() {
    ...
    function btnSaveClicked() {
      ...
      Swal.fire({
        ...
        <tr><td class="text-left">Start Date</td><td>&nbsp; : &nbsp;</td><td class="text-left"> ${start_date}</td></tr>
        <tr><td class="text-left">End Date</td><td>&nbsp; : &nbsp;</td><td class="text-left"> ${end_date}</td></tr>
        <tr><td class="text-left">Status</td><td>&nbsp; : &nbsp;</td><td class="text-left"> ${status == 1 ? 'Active' : 'Inactive'}</td></tr>
