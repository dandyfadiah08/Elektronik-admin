...
$photo_fullset = empty($dc->photo_fullset) ? $default_photo : $photo_url . 'device_check/' . $dc->photo_fullset;
$photo_imei_registered = empty($dc->photo_imei_registered) ? $default_photo : $photo_url . 'device_check/' . $dc->photo_imei_registered;
...
$photo_fullset_thumb = empty($dc->photo_fullset) ? $default_photo : $photo_thumb_url . 'device_check/' . $dc->photo_fullset;
$photo_imei_registered_thumb = empty($dc->photo_imei_registered) ? $default_photo : $photo_thumb_url . 'device_check/' . $dc->photo_imei_registered;
